...
const Features: FC = () => (
  <section id="features" className="py-20 bg-gradient-to-r from-[#f0feff] to-[#f0feff] dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900">
    <div className="max-w-5xl mx-auto px-6">
<h2 className="text-3xl font-bold text-center mb-6 text-[#ff8a44] dark:text-purple-400">Материалы для печати</h2>
    ...
    <div className="space-y-8">
      <div>
        <h3 className="text-xl font-semibold mb-2 text-[#ff8a44] dark:text-purple-300">PLA</h3>
      ...
      <div>
        <h3 className="text-xl font-semibold mb-2 text-[#ff8a44] dark:text-purple-300">PETG</h3>
        <p className="text-gray-600 dark:text-gray-300">
      ...
      <div>
        <h3 className="text-xl font-semibold mb-2 text-[#ff8a44] dark:text-purple-300">ABS</h3>
        <p className="text-gray-600 dark:text-gray-300">
      ...
      <div>
        <h3 className="text-xl font-semibold mb-2 text-[#ff8a44] dark:text-purple-300">Carbon (углеродное волокно)</h3>
        <p className="text-gray-600 dark:text-gray-300">
